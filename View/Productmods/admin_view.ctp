...
<h2><?php echo __('Productmod'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($productmod['Productmod']['value']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($productmod['Productmod']['weight']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($productmod['Productmod']['views']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Productmod'), array('action' => 'delete', $productmod['Productmod']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $productmod['Productmod']['id']))); ?> </li>
